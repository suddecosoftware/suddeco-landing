/**
 * Hero: Cinematic hero with wireframe construction background
 * Design: Forge & Build — massive headline, amber accents, dramatic depth
 * No opacity animations on text — text is always fully visible
 * Includes product demo dashboard mockup below the fold
 */
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden" style={{ marginTop: "-72px", paddingTop: "72px" }}>
      ...
      {/* Hero content — NO opacity animation, text always at full brightness */}
      <div className="container relative z-10" style={{ paddingTop: "5rem", paddingBottom: "4rem" }}>
        <div style={{ maxWidth: "48rem" }}>
          ...
          <div
            ...
            style={{ marginTop: "3rem", fontSize: "0.875rem", color: "#CBD5E1" }}
          >
      ...
      <div className="container relative z-10" style={{ paddingBottom: "2rem" }}>
        <motion.div
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ height: "6rem", background: "linear-gradient(to top, #0F172A, transparent)" }}
            />
          </div>
