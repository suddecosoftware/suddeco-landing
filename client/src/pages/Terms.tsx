              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody className="text-slate-300">
                    ...
                    <tr className="border-b border-slate-800"><td className="py-3 px-4 font-medium text-white">"Free Trial"</td><td className="py-3 px-4">Discontinued as of 14 April 2026. New customers must subscribe to a paid plan. Existing trial users retain access until their trial period expires.</td></tr>
